...
@section('css')
<link rel="stylesheet" href="{{asset('/public/asset/admin/')}}/css/colorpicker.css" />
<link rel="stylesheet" href="{{asset('/public/asset/admin/')}}/css/datepicker.css" />
<link rel="stylesheet" href="{{asset('/public/asset/admin/')}}/css/uniform.css" />
<link rel="stylesheet" href="{{asset('/public/asset/admin/')}}/css/select2.css" />
<link rel="stylesheet" href="{{asset('/public/asset/admin/')}}/css/bootstrap-wysihtml5.css" />
@endsection
@section('content')
<div id="content">
...
@endsection
@section('script')
<script src="{{asset('/public/asset/admin/')}}/js/bootstrap-colorpicker.js"></script> 
<script src="{{asset('/public/asset/admin/')}}/js/bootstrap-datepicker.js"></script> 
<script src="{{asset('/public/asset/admin/')}}/js/jquery.toggle.buttons.js"></script> 
<script src="{{asset('/public/asset/admin/')}}/js/masked.js"></script> 
...
<script src="{{asset('/public/asset/admin/')}}/js/matrix.form_common.js"></script> 
<script src="{{asset('/public/asset/admin/')}}/js/wysihtml5-0.3.0.js"></script> 
<script src="{{asset('/public/asset/admin/')}}/js/jquery.peity.min.js"></script> 
<script src="{{asset('/public/asset/admin/')}}/js/bootstrap-wysihtml5.js"></script> 
<script>
